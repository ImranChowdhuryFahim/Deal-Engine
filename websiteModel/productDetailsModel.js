module.exports = {
    amazon: {
        ...
        productDescription: 'div[class="a-section a-spacing-medium a-spacing-top-small"]',
        images: 'div[class="imgTagWrapper"]>img',
        productShortDescription: 'div[class="a-row a-expander-container a-expander-extend-container"]',
        sellPrice: 'div[class="a-size-medium a-color-price priceBlockBuyingPriceString"]',
        regularPrice: "null",
        suffix: "",
    },
    jbhifi: {
    ...
    bigw: {
        ...
        productShortDescription: 'div[class="TabContent active-true product-specifications"]',
    ...
    banggood: {
        ...
        productShortDescription: 'div[class="tab-cnt-specification product_spec_wrap hide"]',
